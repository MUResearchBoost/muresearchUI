...
<div class="modal" v-if="seen">
  <div class="modal-content">
    <div class="modal-content-container">
        ...
        <hr/>
        <div class="recommendation" v-if="this.$store.getters.getRecSeen">
          <h2>Relative recommendation:</h2>
          <div v-for="publication1 in recommendationlist" :key="publication1.otherId.PMID">
            <Card
...
export default {
  ...
  computed: {
    ...
    recommendationlist () {
      return this.$store.getters.getReccomendationResults
    }
  },
  methods: {
    closeModal: function () {
      this.$store.dispatch('rmModalPublication')
      this.$store.dispatch('rmReccomendation')
    }
  }
}
